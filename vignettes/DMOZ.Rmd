...
The DMOZ directory of URLs contains about 3.7 million URLs (as of April 2015), and each URL is classified into a \emph{topic} in the DMOZ topic hierarchy, which contains about 600,000 unique topics. The topic hierarchy is a tree whose maximum depth is 15 levels. In this vignette we will describe:
